...
module.exports = {
  ...
  */
  head: {
    ...
    meta: [
      ...
      { name: 'author', content: 'Karan Chandna' }
    ],
    link: [
      { rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' },
      { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700' },
      { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Abel&display=swap'},
      { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Livvic&display=swap'},
  ...
  */
  manifest: {
    name: 'Karan Chandna Blog',
    short_name: 'Karan chandna',
    description: 'CA and Lawyer',
    theme_color: '#172b4d',
  },
